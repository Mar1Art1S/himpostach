        ...
        <div class="flex flex-col items-center justify-center mt-5 space-y-3">
            ...
            <div x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen = false"
                ...
                <button @click="modalOpen=true"
                    class="inline-block w-40 px-12 py-3 m-2 text-sm text-white bg-blue-800 border border-white rounded font-r500
                     hover:bg-transparent hover:text-white focus:outline-none focus:ring active:text-white disabled:opacity-75 lf:py-2 lf:px-4 lf:w-24">
                    {{ __('TDS') }}</button>
