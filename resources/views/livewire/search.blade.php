                    ...
                    $options['parameter'] }}</div>
                        ...
                        <div class="back xs:hidden">
                            ...
                            <div class="flex flex-col items-center justify-center mt-5 space-y-3">
                                <x-modal title="{{ __('search.search_ordering_goods') }}" :product="$product">
                                    <x-slot:button>
                                        <x-button @click="modalOpen=true"
                                                  class="w-40 lf:py-2 lf:px-4 lf:w-24">{{ __('search.search_buy') }}</x-button>
                                    </x-slot>
                                ...
                                @if($product->tehcarta_content)
                                    <div x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen = false"
                                        ...
                                        <button @click="modalOpen=true"
                                            ...
                                            {{ __('search.search_technological_map') }}
                                        </button>
                    ...
                    <div class="hidden xs:block">
                        <div class="xs:w-[350px] xs:h-auto xs:bg-slate-600">
                            ...
                            <div class="hidden xs:flex xs:flex-col xs:items-center xs:justify-center xs:mt-5 xs:space-y-3">
                                ...
                                @if(!empty($product->tehcarta_content))
                                    <div x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen = false" class="relative z-50 w-auto h-auto">
                                        ...
                                        <!-- Модальне вікно -->
                                        <template x-teleport="body">
                                            <div x-show="modalOpen" class="fixed inset-0 z-[99] flex items-center justify-center w-screen h-screen"
                                                 x-cloak>
                                                <!-- Фонове затемнення -->
                                                <div x-show="modalOpen" @click="modalOpen=false"
                                                     class="absolute inset-0 w-full h-full bg-black bg-opacity-40"></div>
